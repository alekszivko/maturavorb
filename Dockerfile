FROM registry.jetbrains.team/p/writerside/builder/writerside-builder:233.14938 as build

ARG INSTANCE=Writerside/mv
...
RUN unzip webHelpMV2-all.zip -d /opt/wrs-output/unzipped-artifact
